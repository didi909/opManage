...
class WorkItem(models.Model):
    ...
    others_workitems_from = models.ForeignKey('self', related_name='others_workitems_to', null=True, blank=True)
    push_roles = models.ForeignKey(Group, related_name='push_workitems', null=True, blank=True)
    pull_roles = models.ForeignKey(Group, related_name='pull_workitems', null=True, blank=True)
